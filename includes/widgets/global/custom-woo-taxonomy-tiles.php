...
class Custom_Woo_Taxonomy_Tiles extends Custom_Woo_Builder_Base {
	public $__current_tax_count = 0;

	public function get_name() {
		return 'custom-woo-taxonomy-tiles';
	}

	public function get_title() {
		return esc_html__( 'Taxonomy Tiles', 'custom-woo-builder' );
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'custom-woo-builder/taxonomy-tiles/css-scheme',
			array(
				'wrap'       => '.custom-woo-taxonomy-tiles',
				'box'        => '.custom-woo-taxonomy-item__box',
				'box-inner'  => '.custom-woo-taxonomy-item__box-inner',
				'title'      => '.custom-woo-taxonomy-item__box-title',
				'count'      => '.custom-woo-taxonomy-item__box-count',
				'desc'       => '.custom-woo-taxonomy-item__box-description',
				'terms_link' => '.custom-woo-taxonomy-item__box-link',
			)
		);
		...
		$this->start_controls_section(
			'section_box_style',
			array(
				'label'      => esc_html__( 'Box', 'custom-woo-builder' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Box (Hover)', 'custom-woo-builder' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
	...
	protected function render() {
		...
		if ( empty( $query ) || is_wp_error( $query ) ) {
			echo sprintf( '<h3 class="custom-woo-taxonomy__not-found">%s</h3>', esc_html__( 'Taxonomy not found', 'custom-woo-builder' ) );
	...
	public function __get_tax_wrap_classes() {
		...
		$classes = array(
			'custom-woo-taxonomy-tiles',
			'custom-woo-taxonomy-tiles--layout-' . $settings['layout'],
			'custom-woo-taxonomy-tiles-count--' . $settings['count_displaying']
		);

		if ( 'out-of-content' === $settings['count_displaying'] ) {
			$classes[] = 'custom-woo-taxonomy-tiles-count--' . $settings['boxes_count_position'];
		}
	...
	public function __taxonomy_query() {
		...
		$defaults = apply_filters(
			'custom-woo-builder/custom-woo-taxonomy-tiles/query-args',
			array(
				'post_status'  => 'publish',
				'hierarchical' => 1
			)
	...
	public function is_multirow_layout( $layout ) {
		$multirow_layouts = apply_filters( 'custom-woo-builder/taxonomy-tiles/multirow-layouts', array(
			'2-x',
			'3-x',
			'4-x'
		) );
	...
	public function __layout_data() {
		...
		return apply_filters( 'custom-woo-builder/taxonomy-tiles/available-layouts', array(
			'2-1-2'   => array(
				'label'    => esc_html__( 'Layout 1 (5 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-1',
				'num'      => 5,
				'has_rows' => false,
			),
			'1-1-2-h' => array(
				'label'    => esc_html__( 'Layout 2 (4 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-2',
				'num'      => 4,
				'has_rows' => false,
			),
			'1-1-2-v' => array(
				'label'    => esc_html__( 'Layout 3 (4 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-3',
				'num'      => 4,
				'has_rows' => false,
			),
			'1-2'     => array(
				'label'    => esc_html__( 'Layout 4 (3 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-4',
				'num'      => 3,
				'has_rows' => false,
			),
			'2-3-v'   => array(
				'label'    => esc_html__( 'Layout 5 (5 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-5',
				'num'      => 5,
				'has_rows' => false,
			),
			'1-2-2'   => array(
				'label'    => esc_html__( 'Layout 6 (5 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-6',
				'num'      => 5,
				'has_rows' => false,
			),
			'2-x'     => array(
				'label'    => esc_html__( 'Layout 7 (2, 4, 6 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-7',
				'num'      => 2,
				'has_rows' => false,
			),
			'3-x'     => array(
				'label'    => esc_html__( 'Layout 8 (3, 6, 9 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-8',
				'num'      => 3,
				'has_rows' => false,
			),
			'4-x'     => array(
				'label'    => esc_html__( 'Layout 9 (4, 8, 12 taxonomy)', 'custom-woo-builder' ),
				'icon'     => 'custom-woo-builder-icon custom-woo-taxonomy-tiles-layout-9',
				'num'      => 4,
				'has_rows' => false,
			),
	...
	protected function controls_section_general( $css_scheme ) {
		...
		$this->add_control(
			'count_displaying',
			array(
				'label'   => esc_html__( 'Show Count', 'custom-woo-builder' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'in-content',
				'options' => array(
					'in-content' => esc_html__( 'In content', 'custom-woo-builder' ),
					'out-of-content' => esc_html__( 'Out of content', 'custom-woo-builder' ),
				),
			)
		);
		...
		$main_img_selectors = apply_filters( 'custom-woo-builder/taxonomy-tiles/main-image-selectors', array(
			'{{WRAPPER}} .custom-woo-taxonomy-tiles--layout-2-1-2'   => 'grid-template-columns: 1fr {{SIZE}}{{UNIT}} 1fr; -ms-grid-columns: 1fr {{SIZE}}{{UNIT}} 1fr;',
			'{{WRAPPER}} .custom-woo-taxonomy-tiles--layout-1-1-2-h' => 'grid-template-columns: {{SIZE}}{{UNIT}} 1fr 1fr; -ms-grid-columns: {{SIZE}}{{UNIT}} 1fr 1fr;',
			'{{WRAPPER}} .custom-woo-taxonomy-tiles--layout-1-1-2-v' => 'grid-template-columns: {{SIZE}}{{UNIT}} 1fr 1fr; -ms-grid-columns: {{SIZE}}{{UNIT}} 1fr 1fr;',
			'{{WRAPPER}} .custom-woo-taxonomy-tiles--layout-1-2'     => 'grid-template-columns: {{SIZE}}{{UNIT}} 1fr; -ms-grid-columns: {{SIZE}}{{UNIT}} 1fr',
			'{{WRAPPER}} .custom-woo-taxonomy-tiles--layout-1-2-2'   => 'grid-template-columns: {{SIZE}}{{UNIT}} 1fr 1fr; -ms-grid-columns: {{SIZE}}{{UNIT}} 1fr 1fr;',
		) );

		$main_img_conditions = apply_filters( 'custom-woo-builder/taxonomy-tiles/main-image-conditions', array(
			'2-1-2',
			'1-1-2-h',
			'1-1-2-v',
			'1-2',
		...
		$this->add_control(
			'main_img_width',
			array(
				'label'       => esc_html__( 'Main Box Width', 'custom-woo-builder' ),
				'label_block' => true,
				'type'        => Controls_Manager::SLIDER,
				'size_units'  => array( '%' ),
				'default'     => array(
		...
		$this->add_control(
			'rows_num',
			array(
				'label'     => esc_html__( 'Rows Number', 'custom-woo-builder' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 1,
				'options'   => custom_woo_builder_tools()->get_select_range( 3 ),
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				'type'      => 'select',
				'label'     => esc_html__( 'Show:', 'custom-woo-builder' ),
				'default'   => 'product_cat',
				'options'   => array(
					'product_tag' => esc_html__( 'Tags', 'custom-woo-builder' ),
					'product_cat' => esc_html__( 'Categories', 'custom-woo-builder' ),
				),
				'separator' => 'before'
			)
		);
		...
		$this->add_control(
			...
			array(
				'type'         => 'switcher',
				'label'        => esc_html__( 'Show by IDs', 'custom-woo-builder' ),
				'label_on'     => esc_html__( 'Yes', 'custom-woo-builder' ),
				'label_off'    => esc_html__( 'No', 'custom-woo-builder' ),
				'return_value' => 'yes',
				'default'      => 'false'
		...
		$this->add_control(
			...
			array(
				'type'        => 'text',
				'label_block' => true,
				'label'       => esc_html__( 'Exclude taxonomy by IDs (eg. 10, 22, 19 etc.)', 'custom-woo-builder' ),
				'default'     => '',
			)
		);
		...
		$this->add_control(
			...
			array(
				'type'         => 'switcher',
				'label'        => esc_html__( 'Show Counts', 'custom-woo-builder' ),
				'label_on'     => esc_html__( 'Yes', 'custom-woo-builder' ),
				'label_off'    => esc_html__( 'No', 'custom-woo-builder' ),
				'return_value' => 'yes',
				'default'      => 'yes',
		...
		$this->add_control(
			'title_length',
			array(
				'label'       => esc_html__( 'Title Max Length (Words)', 'custom-woo-builder' ),
				'description' => esc_html__( 'Set 0 to show full title', 'custom-woo-builder' ),
		...
		$this->add_control(
			'desc_length',
			array(
				'label'       => esc_html__( 'Description Length', 'custom-woo-builder' ),
				'description' => esc_html__( 'Set 0 to hide description', 'custom-woo-builder' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => 50,
				'min'         => - 1,
				'max'         => 200,
	...
	protected function controls_section_box( $css_scheme ) {
		...
		$this->add_responsive_control(
			'boxes_gap',
			array(
				'label'       => esc_html__( 'Gap Between Boxes', 'custom-woo-builder' ),
				'label_block' => true,
				'type'        => Controls_Manager::SLIDER,
				'size_units'  => array( 'px' ),
				'default'     => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Box Overlay', 'custom-woo-builder' ),
	...
	protected function controls_section_box_hover( $css_scheme ) {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-inner' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-title' => 'color: {{VALUE}}',
				),
			)
		);
	  ...
	  $this->add_control(
		  ...
		  array(
			  ...
			  'selectors' => array(
				  '{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-title' => 'text-decoration: {{VALUE}}',
			  ),
		  )
	  );
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-description' => 'color: {{VALUE}}',
				),
			)
		);
	  ...
	  $this->add_control(
		  ...
		  array(
			  ...
			  'selectors' => array(
				  '{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-description' => 'text-decoration: {{VALUE}}',
			  ),
		  )
	  );
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-count' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-count' => 'background-color: {{VALUE}}',
				),
			)
		);
	  ...
	  $this->add_control(
		  ...
		  array(
			  ...
			  'selectors' => array(
				  '{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-count' => 'text-decoration: {{VALUE}}',
			  ),
		  )
	  );
	...
	protected function controls_section_content( $css_scheme ) {
	  ...
	  $this->add_control(
		  ...
		  array(
			  ...
			  'type'      => Controls_Manager::COLOR,
			  'selectors' => array(
				  '{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-inner' => 'border-color: {{VALUE}}',
			  ),
		  )
	  );
		...
		$this->add_control(
			'boxes_count_styles',
			array(
				'label'     => esc_html__( 'Products Count', 'custom-woo-builder' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'top-left'     => esc_html__( 'Top Left', 'custom-woo-builder' ),
					'top-right'    => esc_html__( 'Top Right', 'custom-woo-builder' ),
					'bottom-left'  => esc_html__( 'Bottom Left', 'custom-woo-builder' ),
					'bottom-right' => esc_html__( 'Bottom Right', 'custom-woo-builder' ),
				),
				'default'   => 'top-right',
				'condition' => array(
		...
		$this->add_control(
			'boxes_count_display',
			array(
				'label'     => esc_html__( 'Count Display', 'custom-woo-builder' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'inline' => esc_html__( 'Inline', 'custom-woo-builder' ),
	  ...
	  $this->add_control(
		  ...
		  array(
			  ...
			  'type'      => Controls_Manager::COLOR,
			  'selectors' => array(
				  '{{WRAPPER}} ' . $css_scheme['box'] . ':hover .custom-woo-taxonomy-item__box-count' => 'border-color: {{VALUE}}',
			  ),
		  )
	  );
