...
class Custom_Woo_Builder_Single_Related extends Custom_Woo_Builder_Base {

	public function get_name() {
		return 'custom-single-related';
	}

	public function get_title() {
		return esc_html__( 'Single Related Products', 'custom-woo-builder' );
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'custom-woo-builder/custom-single-related/css-scheme',
			array(
				'title' => '.custom-woo-builder > .related.products > h2'
			)
		);
