...
class Custom_Woo_Builder_Single_Title extends Custom_Woo_Builder_Base {

	public function get_name() {
		return 'custom-single-title';
	}

	public function get_title() {
		return esc_html__( 'Single Title', 'custom-woo-builder' );
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'custom-woo-builder/custom-single-title/css-scheme',
			array(
				'title' => '.custom-woo-builder .product_title'
			)
		);
